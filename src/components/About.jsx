  ...
  return (
    <section id="about" className={`flex md:flex-row flex-col mb-10`}>
        <div className="flex flex-col w-[100%] h-[100%] md:flex-row md:w-[100vw] md:h-[100vh]">
          ...
          <div className="flex-1 px-3 md:px-0 h-[60%] md:w-[50%] md:h-[100%] mt-0 text-center md:text-left">
            <h1 className='font-bold text-6xl md:text-8xl pr-0 font-poppins text-center'>Hello <span className="text-yellow-400">there.</span></h1>
              ...
              <button className='border-solid border-2 border-black px-3 py-2 mt-3 rounded-md text-center'><a href={Resume}>Resume</a></button>
          </div>
        </div>
